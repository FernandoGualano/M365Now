...
## v1.0.3
- Abre enlaces de artículos y roadmap en navegador externo.
- Corrige navegación desde categorías de Inicio a Artículos filtrados por la categoría seleccionada.
- Actualiza fuentes RSS de Microsoft Tech Community al formato `t5/s/gxcuf89792/rss/board`.
- Actualiza fuentes de Intune y SharePoint/OneDrive.
- Agrega ícono de app inicial.
- Agrega colores por categoría y badges visuales por producto.
- Sube la base Room a versión 3 para limpiar datos viejos de pruebas anteriores.
